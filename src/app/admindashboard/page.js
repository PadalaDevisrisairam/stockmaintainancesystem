...
const AdminDashboard = () => {  // Component name must start with uppercase
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {products.map((product) => (
            ...
            >
              ...
              <p className="text-lg text-gray-600 text-center p-3">
...
export default AdminDashboard; // Export the component with uppercase name
